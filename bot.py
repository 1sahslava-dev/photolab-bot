        ...
        "questions": [
            ...
            },
            {
                ...
                "explanation": (
                    ...
                    "Изображение создавалось действием света на чувствительный материал."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Гелиография»*.\n"
                    "От греч. helios — солнце, grapho — рисую. Метод Ньепса буквально — рисование солнцем."
                ),
            },
            {
                ...
                "explanation": (
                    ...
                    "поэтому изображению требовались многие часы, чтобы закрепиться."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Материал был очень малочувствительным к свету»*.\n"
                    "Первая фотография Ньепса потребовала около 8 часов экспозиции."
                ),
            },
            {
                ...
                "explanation": (
                    "✅ Верно!\n"
                    "Ньепс использовал металлическую пластину, покрытую светочувствительным битумом. "
                    "Свет изменял покрытие и оставлял на нём изображение."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Металлическая пластина с битумным покрытием»*.\n"
                    "Битум Иудейский — природная смола, светлеющая под воздействием света."
                ),
            },
            {
                ...
                "explanation": (
                    "✅ Верно!\n"
                    "До Ньепса изображение можно было увидеть в Camera Obscura, но оно исчезало. "
                ...
                "wrong_explanation": (
                    ...
                    "Это и есть рождение фотографии — момент, когда свет научился помнить."
                ),
            },
        ],
    },
