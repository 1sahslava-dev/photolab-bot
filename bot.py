...
},
{
    ...
    },
  {
        "module": 1,
        "topic": 8,
        "title": "Рождение фотоплёнки",
        "subtitle": "Патентная гонка, которая изменила индустрию",
        "intro": (
            "📷 *Модуль 1 · Тема 8*\n"
            "*Рождение фотоплёнки*\n\n"
            "К концу 1880-х бумажная плёнка уже работала, но у неё был серьёзный "
            "недостаток — эмульсию приходилось вручную отделять от бумажной основы.\n"
            "Настоящий прорыв случился, когда на смену бумаге пришёл прозрачный и "
            "гибкий целлулоид — и началась патентная война.\n\n"
            "Готов проверить знания? 👇"
        ),
        "questions": [
            {
                "text": "❓ В каком году Kodak представил камеру №1, заряженную рулонной плёнкой?",
                "options": [
                    "1875",
                    "1888",
                    "1901",
                ...
                "explanation": (
                    "✅ Верно!\n"
                    "В 1888 году Джордж Истман выпустил камеру Kodak №1 под лозунгом "
                    "«Вы нажимаете на кнопку — остальное делаем мы»."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«1888»*.\n"
                    "Именно в этом году появилась камера Kodak №1 с лозунгом «Вы "
                    "нажимаете на кнопку — остальное делаем мы»."
                ),
            },
            {
                "text": "❓ Кто первым подал патент на гибкую целлулоидную фотоплёнку?",
                "options": [
                    "Джордж Истман, в 1885 году",
                    "Генри Райхенбах, в 1890 году",
                    "Ганнибал Гудвин, в 1887 году",
                ],
                "correct": 2,
                "explanation": (
                    "✅ Верно!\n"
                    "Священник Ганнибал Гудвин подал патент на целлулоидную плёнку в "
                    "1887 году — на два года раньше патента химика Kodak Генри "
                    "Райхенбаха (1889), хотя получил его лишь в 1898-м."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Ганнибал Гудвин, в 1887 году»*.\n"
                    "Он подал патент на два года раньше Генри Райхенбаха, химика, "
                    "работавшего на Kodak."
                ),
            },
            {
                "text": "❓ Почему целлулоид, а не бумага, стал основой настоящей фотоплёнки?",
                "options": [
                    "Бумага пропускала свет неидеально, и эмульсию приходилось отслаивать от неё после проявки",
                    "Бумага была слишком дорогой в производстве",
                    "Бумага годилась только для цветной съёмки",
                ],
                "correct": 0,
                "explanation": (
                    "✅ Верно!\n"
                    "Бумажная рулонная плёнка (1885) была промежуточным решением: "
                    "непрозрачную бумажную основу после проявки приходилось вручную "
                    "отделять от светочувствительного слоя. Целлулоид (1888–89) решил "
                    "эту проблему, будучи прозрачным и гибким одновременно."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Бумага пропускала свет неидеально, и эмульсию "
                    "приходилось отслаивать от неё после проявки»*.\n"
                    "Именно эту проблему решил прозрачный и гибкий целлулоид."
                ),
            },
            {
                "text": "❓ Кем по профессии был Ганнибал Гудвин, изобретший целлулоидную плёнку?",
                "options": [
                    "Профессиональный химик-технолог",
                ...
                "explanation": (
                    "✅ Верно!\n"
                    "Гудвин был настоятелем церкви в Ньюарке. Он занялся "
                    "изобретательством не ради бизнеса, а чтобы найти прочный и гибкий "
                    "материал для проекционных слайдов, которые показывал прихожанам."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«Священник (настоятель прихода)»*.\n"
                    "Он искал прочный и гибкий материал для проекционных слайдов, "
                    "которые показывал прихожанам в церкви."
                ),
            },
            {
                "text": "❓ Чем закончилась патентная тяжба между компанией Ansco (владевшей патентом Гудвина) и Eastman Kodak?",
                "options": [
                    "Суд признал патент Гудвина недействительным, и Kodak не заплатил ничего",
                    "Компании объединились и стали выпускать плёнку совместно",
                    "В 1914 году, спустя почти три десятилетия, Ansco выиграла у Kodak 5 миллионов долларов компенсации",
                ],
                "correct": 2,
                "explanation": (
                    "✅ Верно!\n"
                    "Ansco, выкупившая патентные права после смерти Гудвина, подала иск "
                    "в 1902 году и выиграла в 1914-м 5 миллионов долларов — но к этому "
                    "времени Kodak уже прочно занимал первое место на рынке."
                ),
                "wrong_explanation": (
                    "❌ Не совсем.\n"
                    "Правильный ответ: *«В 1914 году Ansco выиграла у Kodak 5 миллионов "
                    "долларов компенсации»*.\n"
                    "К моменту победы в суде Kodak уже прочно занимал первое место на "
                    "рынке."
                ),
            },
        ],
